...
/**
 * Extensión de std::thread para agregar funcionalidad que permita generar
 * objetos activos de manera más clara y legible. 
*/
class Thread {
    private:
    std::thread thread;
    ...
    public:
        ...
        */
         ...
         * método RUN, a ser overrideado por clases hijas.
         * Parametros: -
         * Retorno: -
        */
        void start();
