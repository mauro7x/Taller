...
bool loadMedia() {
    ...
    if (gFont == NULL) {
        ...
        if (!gStartPromptTexture.loadFromRenderedText(
        ...
        if (!gPausePromptTexture.loadFromRenderedText(
    ...
    if (!init()) {
        ...
        if (!loadMedia()) {
            ...
            while (!quit) {
                ...
                // Render text
                if (!gTimeTextTexture.loadFromRenderedText(
                        timeText.str().c_str(), textColor)) {
