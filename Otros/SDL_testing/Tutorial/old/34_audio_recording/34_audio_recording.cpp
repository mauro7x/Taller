...
bool loadMedia() {
    ...
    if (gFont == NULL) {
        ...
        // Set starting prompt
        gPromptTexture.loadFromRenderedText("Select your recording device:",
                                            gTextColor);
        ...
        // At least one device connected
            ...
            for (int i = 0; i < gRecordingDeviceCount; ++i) {
                ...
                gDeviceTextures[i].loadFromRenderedText(
                    promptText.str().c_str(), gTextColor);
            }
        }
    }
        ...
        if (!loadMedia()) {
            ...
            while (!quit) {
                                ...
                                if (e.key.keysym.sym >= SDLK_0 &&
                                    ...
                                    if (index < gRecordingDeviceCount) {
                                        ...
                                        // Device opened successfully
                                            ...
                                            desiredPlaybackSpec.format =
                                                AUDIO_F32;
                                            desiredPlaybackSpec.channels = 2;
                                            desiredPlaybackSpec.samples = 4096;
                                            desiredPlaybackSpec.callback =
                                            ...
                                            // Device opened successfully
                                                ...
                                                // Allocate and initialize byte
                                                // buffer
                                                gRecordingBuffer =
                                                    new Uint8[gBufferByteSize];
                                                memset(gRecordingBuffer, 0,
                                                       gBufferByteSize);

                                                // Go on to next state
                                                gPromptTexture
                                                    .loadFromRenderedText(
                                                        "Press 1 to record for "
                                                        "5 seconds.",
                                                        gTextColor);
                        ...
                        case STOPPED:
                            ...
                            if (e.type == SDL_KEYDOWN) {
                                ...
                                if (e.key.keysym.sym == SDLK_1) {
                                    ...
                                    // Start recording
                                    SDL_PauseAudioDevice(recordingDeviceId,
                                                         SDL_FALSE);

                                    // Go on to next state
                                    gPromptTexture.loadFromRenderedText(
                                        "Recording...", gTextColor);
                        ...
                        case RECORDED:
                            ...
                            if (e.type == SDL_KEYDOWN) {
                                ...
                                if (e.key.keysym.sym == SDLK_1) {
                                    ...
                                    // Start playback
                                    SDL_PauseAudioDevice(playbackDeviceId,
                                                         SDL_FALSE);
                ...
                gPromptTexture.render(
                    (SCREEN_WIDTH - gPromptTexture.getWidth()) / 2, 0);
