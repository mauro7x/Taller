...
bool loadMedia() {
    ...
    if (gFont == NULL) {
        ...
        // Render the prompt
        if (!gPromptTextTexture.loadFromRenderedText("Enter Data:",
                                                     textColor)) {
    ...
    for (int i = 1; i < TOTAL_DATA; ++i) {
        gDataTextures[i].loadFromRenderedText(std::to_string(gData[i]),
                                              textColor);
    }
                        ...
                        switch (e.key.keysym.sym) {
                            ...
                            case SDLK_UP:
                                ...
                                gDataTextures[currentData].loadFromRenderedText(
                                    std::to_string(gData[currentData]),
                                    textColor);
                                --currentData;
                                if (currentData < 0) {
